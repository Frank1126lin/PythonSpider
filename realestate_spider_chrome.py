...
def browser_using(browser, keys, area):
    ...
    for i in range(max_page):
        ...
        next_button = browser.find_element(
            By.ID, "MainContent_PageGridView1_Next_0")
        next_button.click()
    # 将data存储到df中
...
if __name__ == '__main__':
    ...
    browser.get(
        'http://spf.szfcweb.com/szfcweb/DataSerach/CanSaleHouseSelectIndex.aspx')
